...
from app.services.attendance_service import count_attendance_records, count_present_today
...
async def get_dashboard_stats():
    total_employees, total_attendance, present_today = await _gather_stats()
    return {
